...
public class SignersTestContainer extends TestContainer {

    public SignersTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/signers/app.properties",
    ...
    public static class Common extends SignersTestContainer {

        public static final SignersTestContainer.Common INSTANCE = new SignersTestContainer.Common();
